...
impl ToolRegistry {
    pub fn new(config: &Config, channel_registry: Arc<ChannelRegistry>, db: Arc<Database>) -> Self {
        ...
        let tools: Vec<Box<dyn Tool>> = vec![
            ...
            Box::new(desktop::MouseClickTool),
            Box::new(desktop::MouseMoveTool),
            Box::new(desktop::TypeTextTool),
            Box::new(desktop::PressKeyTool),
            Box::new(desktop::MouseScrollTool),
            Box::new(desktop::FindTextTool),
            Box::new(desktop::GetMousePositionTool),
